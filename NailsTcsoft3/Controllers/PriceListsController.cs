...
namespace NailsTcsoft3.Controllers
{
    ...
    public class PriceListsController : ControllerBase
    {
       ...
       // [ClaimRequirement(PermissionAction.PRICELIST_VIEW)]
       ...
       // [ClaimRequirement(PermissionAction.PRICELIST_ADD)]
        ...
        [HttpGet("GetByFilter")]
        [Authorize(policy: "PRICELIST:SEARCH")]
        ...
        [Authorize(policy: "PRICELIST:EDIT")]
        ...
        [Authorize(policy: "PRICELIST:DELETE")]
