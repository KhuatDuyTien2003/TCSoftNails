...
var NzCheckboxComponent = class _NzCheckboxComponent {
  ...
  ngOnInit() {
    ...
    fromEventOutsideAngular(this.elementRef.nativeElement, "click").pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((event) => {
    ...
    fromEventOutsideAngular(this.inputElement.nativeElement, "click").pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((event) => event.stopPropagation());
  }
  ngAfterViewInit() {
    if (this.nzAutoFocus) {
      this.focus();
